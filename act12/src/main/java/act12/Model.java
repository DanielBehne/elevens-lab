...
public class Model implements MessageHandler {
    ...
    public void init() {
        ...
        mvcMessaging.subscribe("view:playBtnActionPerformed", this);
        mvcMessaging.subscribe("view:clearAllBtnActionPerformed", this);
        mvcMessaging.subscribe("view:newGameBtnActionPerformed", this);
